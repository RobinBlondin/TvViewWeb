...
export const createSlide = async (slideModel: SlideModel): Promise<SlideModel> => {
    return apiClient.post(`${API_BASE_URL}/create`, slideModel).then((res) => res.data)
}

export const updateSlide = async (slideModel: SlideModel): Promise<SlideModel> => {
    return apiClient.put(`${API_BASE_URL}/edit`, slideModel).then((res) => res.data)
}
